...
class EventReportPage extends StatelessWidget {
  ...
  final List<dynamic> members; // pass members for stats
              ...
              child: Column(
                ...
                children: [
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: AppPallete.buttonColor.withOpacity(0.2),
                  ...
                  _InfoRow(
                    ...
                    label: 'Tanggal Mulai',
                    value: dateFormatter.format(event.startAt),
                  ),
                  const SizedBox(height: 8),
                  _InfoRow(
                    icon: Icons.event_available_outlined,
                    label: 'Tanggal Selesai',
                    value: dateFormatter.format(event.endAt),
                  ),
                  const SizedBox(height: 8),
                  _InfoRow(
